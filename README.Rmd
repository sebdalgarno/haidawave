...
Wind-altered fetch is calculated by weighting fetch lines according to proportion of time that weind blew in that. User may define years, months and which stations are included for determination of weighting factors. 
